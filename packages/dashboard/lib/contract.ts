...
const ESCROW_ABI = [
    "function getEscrow(uint256 _escrowId) external view returns (tuple(uint256 id, address agent, address provider, uint256 amount, string endpoint, bytes32 deliveryHash, bytes32 receiptHash, uint8 state, uint256 createdAt, uint256 deliveredAt, uint256 timeout))",
